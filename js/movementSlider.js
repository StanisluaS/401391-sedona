...
(function () {
  ...
  var buttonsField = document. querySelector('.slider-min-max');
  var fieldWidth = buttonsField.clientWidth;
  var line = buttonsField.querySelector('.line');
  var btnMin = buttonsField.querySelector('.slider-min');
  var btnMax = buttonsField.querySelector('.slider-max');
  var costInput = document.querySelector('.cost-input');
  var inputs = costInput.querySelectorAll('input');
  var inputMin = costInput.querySelector('.input-min');
  var inputMax = costInput.querySelector('.input-max');
...
var onMoveSliders = function (evt) {
  ...
  switch (target.className) {
    case 'input-min':
      ...
      line.style.marginLeft = Math.round(btnMin.offsetLeft) + 'px';
  ...
  line.style.width = (btnMax.offsetLeft - btnMin.offsetLeft) + 'px';
};
